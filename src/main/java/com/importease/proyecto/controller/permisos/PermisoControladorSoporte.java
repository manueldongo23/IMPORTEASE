...
public class PermisoControladorSoporte {
    private final PermisoConsultaServicio queryService;
    private final PermisoComandoServicio commandService;
    private final PermisoAuditoriaServicio auditService;
    private final OperacionAutorizacionServicio authorizationService;
    private final Gson gson;

    public PermisoControladorSoporte(PermisoConsultaServicio queryService, PermisoComandoServicio commandService, PermisoAuditoriaServicio auditService, OperacionAutorizacionServicio authorizationService, Gson gson) {
    ...
    public PermisoConsultaServicio queryService() { return queryService; }
    public PermisoComandoServicio commandService() { return commandService; }
    public PermisoAuditoriaServicio auditService() { return auditService; }
    public OperacionAutorizacionServicio authorizationService() { return authorizationService; }
