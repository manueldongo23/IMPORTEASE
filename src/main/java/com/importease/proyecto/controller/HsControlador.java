...
@WebServlet("/api/hs/*")
public class HsControlador extends HttpServlet {

    private final ArancelServicio arancelServicio = new ArancelServicio();
    private final HsCodeRepositorio hsDao = new HsCodeRepositorio();
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if ("/buscar".equals(path)) {
            ...
            if (codigo != null && !codigo.isEmpty()) {
                hs = arancelServicio.consultarArancel(codigo);
            ...
            if (hs != null) {
                ...
                if (usuarioId != null) {
                    try {
                        ...
                        arancelServicio.registrarAuditoria(usuarioId, hs, "CONSULTA");
                        com.importease.proyecto.service.AuditoriaServicio.registrar(
                                usuarioId,
                                "BUSQUEDA_HS",
                                "arancel",
                                null,
                ...
                response.put("confidence", DataConfidenceServicio.confidenceFor("BD_LOCAL"));
