...
import com.importease.proyecto.service.FuentesRealesServicio;
import com.importease.proyecto.service.SunatCargaMasivaServicio;
import com.importease.proyecto.service.VeritradeIngestor;
import com.importease.proyecto.service.VuceValidadorServicio;
import com.importease.proyecto.service.VucePamServicio;
...
public class FuentesControlador extends HttpServlet {
    private final Gson gson = new Gson();
    private final FuentesRealesServicio fuentesService = new FuentesRealesServicio();
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (!isLoggedIn(req)) {
            resp.setStatus(401);
            write(resp, RespuestaEnvoltorio.error("SESSION_REQUIRED", "Inicia sesion para consultar fuentes.", "BD_LOCAL", false));
            return;
        }
        ...
        try {
            ...
            resp.setStatus(500);
            write(resp, RespuestaEnvoltorio.error("FUENTES_QUERY_ERROR", "No se pudo consultar fuentes reales.", "BD_LOCAL", false));
        }
    }
    ...
    private void writeOk(HttpServletResponse resp, Object data, String source, String sourceType) throws IOException {
        write(resp, RespuestaEnvoltorio.ok(data, source, sourceType, DataConfidenceServicio.confidenceFor(sourceType)));
    }
