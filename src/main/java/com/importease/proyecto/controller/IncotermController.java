...
import com.importease.proyecto.service.IncotermService;
...
public class IncotermController extends HttpServlet {
    private final Gson gson = new Gson();
    private final IncotermService service = new IncotermService();
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (path == null || "/listar".equals(path)) {
            ...
            resp.setStatus(404);
            write(resp, ResponseEnvelope.error("ENDPOINT_NOT_FOUND", "Endpoint de incoterms no encontrado", IncotermService.SOURCE, false));
            return;
        }
        write(resp, ResponseEnvelope.ok(data, IncotermService.SOURCE, "BD_LOCAL", DataConfidenceService.confidenceFor("BD_LOCAL")));
    }
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            resp.setStatus(500);
            write(resp, ResponseEnvelope.error("INCOTERM_ERROR", "No se pudo procesar Incoterms", IncotermService.SOURCE, false));
        }
    }
