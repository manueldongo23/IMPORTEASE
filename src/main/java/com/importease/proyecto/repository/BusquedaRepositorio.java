...
/**
 * Repositorio para el registro y consulta de búsquedas de usuarios.
 * Alimenta el módulo de Inteligencia de Mercado (tendencias internas).
 */
public class BusquedaRepositorio {
    ...
    public void registrar(Integer usuarioId, String termino, String hsCode, String tipo) {
        ...
        try (Connection con = ConexionDB.obtenerConexion();
            ...
            LoggerUtil.error("Error al registrar búsqueda", e);
        }
    }

    /**
     * Top N productos más buscados en los últimos X días.
     */
    ...
    /**
     * Evolución diaria de búsquedas en los últimos X días.
     */
    public List<Map<String, Object>> evolucionDiaria(int dias) {
        ...
        } catch (SQLException e) { LoggerUtil.error("Error evolución diaria", e); }
        return lista;
    }

    /**
     * Evolución diaria para términos específicos (comparativa).
     */
    ...
    /**
     * Categorías HS más consultadas (por capítulo arancelario).
     */
    public List<Map<String, Object>> topCategorias(int dias, int limit) {
        ...
        } catch (SQLException e) { LoggerUtil.error("Error top categorías", e); }
        return lista;
    }
    ...
    /**
     * Top productos importados (operaciones reales, no solo búsquedas).
     */
    ...
    /**
     * Total de búsquedas realizadas (estadística general).
     */
    public Map<String, Object> estadisticasGenerales(int dias) {
        ...
        } catch (SQLException e) { LoggerUtil.error("Error estadísticas", e); }
        return stats;
    }
}
