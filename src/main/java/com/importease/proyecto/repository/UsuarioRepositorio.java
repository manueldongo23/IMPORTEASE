...
import com.importease.proyecto.repository.jpa.UsuarioJpaRepositorio;
...
/**
 * Repositorio de base de datos para la entidad de Usuario.
 * No contiene lógica de hashing ni validación de negocio.
 */
public class UsuarioRepositorio implements IUsuarioRepositorio {
    ...
    private boolean guardarConJpa(Usuario usuario) {
        ...
        try {
            ...
            // El password ya viene hashed desde la capa de servicio
    ...
    private UsuarioJpaRepositorio getJpaRepo() {
        return SpringContextHolder.getBeanOrNull(UsuarioJpaRepositorio.class);
    }
