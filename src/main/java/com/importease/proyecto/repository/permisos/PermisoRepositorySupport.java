...
import com.importease.proyecto.repository.jpa.DocumentoPermisoJpaRepository;
import com.importease.proyecto.repository.jpa.EntidadControlJpaRepository;
import com.importease.proyecto.repository.jpa.PreguntaPermisoJpaRepository;
import com.importease.proyecto.repository.jpa.ReglaRestriccionJpaRepository;
import com.importease.proyecto.repository.jpa.RespuestaPermisoOperacionJpaRepository;
import com.importease.proyecto.repository.jpa.SolicitudPermisoDatoJpaRepository;
import com.importease.proyecto.repository.jpa.SolicitudPermisoJpaRepository;

import java.sql.ResultSet;
import java.sql.SQLException;

abstract class PermisoRepositorySupport {

    protected SolicitudPermisoJpaRepository getSolicitudRepo() {
        return SpringContextHolder.getBeanOrNull(SolicitudPermisoJpaRepository.class);
    }

    protected EntidadControlJpaRepository getEntidadRepo() {
        return SpringContextHolder.getBeanOrNull(EntidadControlJpaRepository.class);
    }

    protected ReglaRestriccionJpaRepository getReglaRepo() {
        return SpringContextHolder.getBeanOrNull(ReglaRestriccionJpaRepository.class);
    }

    protected PreguntaPermisoJpaRepository getPreguntaRepo() {
        return SpringContextHolder.getBeanOrNull(PreguntaPermisoJpaRepository.class);
    }

    protected DocumentoPermisoJpaRepository getDocumentoRepo() {
        return SpringContextHolder.getBeanOrNull(DocumentoPermisoJpaRepository.class);
    }

    protected SolicitudPermisoDatoJpaRepository getDatoRepo() {
        return SpringContextHolder.getBeanOrNull(SolicitudPermisoDatoJpaRepository.class);
    }

    protected RespuestaPermisoOperacionJpaRepository getRespuestaRepo() {
        return SpringContextHolder.getBeanOrNull(RespuestaPermisoOperacionJpaRepository.class);
    }
