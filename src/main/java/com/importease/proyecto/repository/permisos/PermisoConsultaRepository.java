...
public class PermisoConsultaRepository extends PermisoRepositorySupport {

    public List<EntidadControl> listarEntidades() {
        EntidadControlJpaRepository repo = getEntidadRepo();
        if (repo != null) {
            try {
    ...
    public List<ReglaRestriccion> buscarReglasPorHsCode(String hsCode) {
        ...
        ReglaRestriccionJpaRepository repo = getReglaRepo();
        if (repo != null) {
            try {
    ...
    public List<PreguntaPermiso> obtenerPreguntasPorEntidad(String codigoEntidad) {
        PreguntaPermisoJpaRepository repo = getPreguntaRepo();
        if (repo != null) {
            try {
