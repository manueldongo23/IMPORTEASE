...
/**
 * Adaptador para SunatRucService que usa el nuevo ExternalApiService.
 */
public class SunatRucService {

    private ExternalApiService externalApi = new ExternalApiService();
    ...
    public Usuario consultarRuc(String ruc) {
        ...
        u.setRucConfianza(DataConfidenceService.confidenceFor(esSimulado ? "SYSTEM_RULE" : "TERCERO_API"));
        return u;
    }
}
