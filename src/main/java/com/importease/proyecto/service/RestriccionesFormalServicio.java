...
public class RestriccionesFormalServicio {
    ...
    public static boolean esRestringido(String hsCode) {
        ...
        try (Connection conn = ConexionDB.obtenerConexion();
            ...
            LoggerUtil.error("RestriccionesFormalServicio: error en BD, fallback a heuristica", e);
        }
    ...
    public static Map<String, Object> verificarRestriccion(String hsCode) {
        ...
        try (Connection conn = ConexionDB.obtenerConexion();
            ...
            LoggerUtil.error("RestriccionesFormalServicio: error en BD al verificar restriccion", e);
        }
    ...
    public static List<Map<String, Object>> obtenerTodasRestricciones() {
        ...
        try (Connection conn = ConexionDB.obtenerConexion();
            ...
            LoggerUtil.error("RestriccionesFormalServicio: error al obtener todas las restricciones", e);
        }
        return lista;
    }
}
