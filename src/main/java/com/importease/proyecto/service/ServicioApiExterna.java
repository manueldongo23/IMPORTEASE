...
public class ServicioApiExterna {
    ...
    private String loadTokenFromProperties() {
        ...
        try (java.io.InputStream is = ServicioApiExterna.class.getClassLoader().getResourceAsStream("config.properties")) {
            if (is != null) {
        ...
        try (java.io.InputStream is = ServicioApiExterna.class.getClassLoader().getResourceAsStream("config-local.properties")) {
            if (is != null) {
                java.util.Properties props = new java.util.Properties();
                props.load(is);
                String val = props.getProperty("peru.api.token");
