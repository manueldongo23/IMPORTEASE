...
public class CorreoRecuperacionServicio {
    ...
    static {
        try (InputStream is = CorreoRecuperacionServicio.class.getClassLoader().getResourceAsStream("config.properties")) {
            if (is != null) {
                props.load(is);
            }
        } catch (Exception e) {
        ...
        try (InputStream is = CorreoRecuperacionServicio.class.getClassLoader().getResourceAsStream("config-local.properties")) {
            if (is != null) {
