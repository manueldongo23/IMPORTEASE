...
public class PermisoPdfServicio {
    private final PermisoRepositorio permisoRepositorio;

    public PermisoPdfServicio() {
        this(new PermisoRepositorio());
    }

    public PermisoPdfServicio(PermisoRepositorio permisoRepositorio) {
    ...
    public byte[] generarExpedientePDF(int solicitudId) {
        ...
        try {
            ...
            EntidadControl entidad = permisoRepositorio.obtenerEntidad(sol.getCodigoEntidad());
            List<DocumentoPermiso> documentos = permisoRepositorio.obtenerDocumentosPorPermiso(sol.getCodigoEntidad(), sol.getTipoPermiso());
