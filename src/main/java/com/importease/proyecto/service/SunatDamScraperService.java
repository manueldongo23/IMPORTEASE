...
public class SunatDamScraperService {

    private static final String DAM_CONSULT_URL = "http://www.sunat.gob.pe/ol-ti-itdamconsul/damex/consultaIntegra";
    ...
    public Map<String, Object> consultarEstadoDam(String damNumber) {
        ...
        try {
            ...
            result.put("raw", html.length() > 500 ? html.substring(0, 500) : html);
            result.putAll(FuenteMetadataBuilder.buildMetadata(
                    "SunatDamScraperService.consultarEstadoDam",
