...
public class AduanasLegalServicio {
    private final AduanasCatalogoProcedimientos procedureCatalog;
    private final AduanasConstructorRespuesta responseBuilder;

    public AduanasLegalServicio() {
        this(new AduanasCatalogoProcedimientos(), new AduanasConstructorRespuesta());
    }

    public AduanasLegalServicio(AduanasCatalogoProcedimientos procedureCatalog, AduanasConstructorRespuesta responseBuilder) {
