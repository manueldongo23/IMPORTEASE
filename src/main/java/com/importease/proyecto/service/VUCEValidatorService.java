...
public class VUCEValidatorService {
    private com.importease.proyecto.repository.IHsCodeDAO hsDao = new com.importease.proyecto.repository.HsCodeDAO();
    private ArancelService arancelService = new ArancelService();
    private VUCEScraper vuceScraper = new VUCEScraper();
    ...
    public Map<String, Object> validar(String hsCode, String producto) {
        ...
        if (hsCode != null && !hsCode.isBlank()) {
            hs = arancelService.consultarArancel(hsCode.replace(".", "").trim());
        }
