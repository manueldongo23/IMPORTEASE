...
public class IncidenciaCoherenciaDTO {
    private String tipo;
    ...
    public IncidenciaCoherenciaDTO() {}

    public IncidenciaCoherenciaDTO(String tipo, String descripcion, String campo, String gravedad, String sugerencia) {
        this.tipo = tipo;
