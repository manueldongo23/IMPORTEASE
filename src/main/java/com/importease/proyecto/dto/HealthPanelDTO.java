...
public class HealthPanelDTO {
    ...
    public NextActionDTO getSiguienteAccion() { return siguienteAccion; }
    public void setSiguienteAccion(NextActionDTO siguienteAccion) { this.siguienteAccion = siguienteAccion; }
