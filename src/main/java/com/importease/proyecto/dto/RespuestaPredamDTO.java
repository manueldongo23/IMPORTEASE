...
public class RespuestaPredamDTO {
    ...
    public RespuestaPredamDTO() {}

    public RespuestaPredamDTO(boolean predamGenerada, String mensaje, List<String> camposFaltantes, List<String> advertencias, Map<String, Object> metadata) {
