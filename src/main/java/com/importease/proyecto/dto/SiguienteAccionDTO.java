...
public class SiguienteAccionDTO {
    ...
    public SiguienteAccionDTO() {}

    public SiguienteAccionDTO(String accion, String motivo, int paso, String prioridad, String bloqueo, List<String> camposFaltantes) {
        this.accion = accion;
        this.motivo = motivo;
        this.paso = paso;
