...
<header class="topbar-shell">
    <div class="flex items-center gap-3">
        <!-- Mobile hamburger -->
        <button onclick="toggleSidebar()" class="mobile-toggle" aria-label="Abrir menú lateral">
            <svg role="img" aria-label="Menú" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
    ...
    <div class="flex items-center gap-4">
        ...
        <div class="search-bar hidden md:block">
            <svg role="img" aria-label="Buscar" class="search-bar__icon" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
        ...
        <div class="user-dropdown">
            <button type="button" class="user-dropdown__trigger" onclick="toggleUserDropdown()" aria-haspopup="true" aria-expanded="false">
                ...
                <svg role="img" aria-label="Desplegar" class="w-3.5 h-3.5 text-[var(--text-tertiary)]" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
            ...
            <div id="userDropdownMenu" class="user-dropdown__menu" role="menu">
                ...
                <a href="dashboard.jsp" class="user-dropdown__item" role="menuitem">
                    <svg role="img" aria-label="Panel principal" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 12l8.954-8.955c.44-.439 1.152-.439 1.591 0L21.75 12M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25"/>
                    </svg>
                    Panel principal
                </a>
                <a href="perfil.jsp" class="user-dropdown__item" role="menuitem">
                    <svg role="img" aria-label="Mi perfil" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                ...
                <button type="button" class="user-dropdown__item" onclick="doLogout()" role="menuitem">
                    <svg role="img" aria-label="Cerrar sesión" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
