...
<body class="auth-page auth-login">
    ...
    <div class="auth-panel-container">
        ...
        <div class="auth-panel-right">
            <div class="auth-card fade-up">
                ...
                <h2 class="auth-card-title">Bienvenido al Cockpit</h2>
                <p class="auth-card-subtitle">Ingresa tus credenciales corporativas para continuar.</p>
                ...
                <form id="loginForm">
                    ...
                    <div class="auth-captcha-box">
                        ...
                        <div class="auth-captcha-row">
                            ...
                            <input type="text" id="captcha" class="auth-captcha-input" placeholder="INPUT ..." maxlength="5" required autocomplete="off">
                        </div>
                    </div>
    ...
    <script nonce="<%= request.getAttribute("csp_nonce") %>" src="js/auth-login.js" defer></script>
</body>
</html>
