...
public class TipoCambioServicioTest {

    private final TipoCambioServicio service = new TipoCambioServicio();
    ...
    public void test10_VerificarCacheDBInsertaYRecuperaCorrectamente() {
        ...
        try (Connection con = ConexionDB.obtenerConexion()) {
            ...
            LoggerUtil.info("Omitiendo validacion estricta de BD si no hay servicio MySQL: " + e.getMessage());
        }
    }
    ...
    public void test11_VerificarTipoCambioDiarioTablaExiste() {
        try (Connection con = ConexionDB.obtenerConexion();
            ...
            LoggerUtil.info("Omitiendo verificacion de existencia de tabla: " + e.getMessage());
        }
    }
    ...
    public void test12_VerificarTipoCambioDiarioEstructuraColumnas() {
        try (Connection con = ConexionDB.obtenerConexion();
            ...
            LoggerUtil.info("Omitiendo verificacion de estructura de columnas: " + e.getMessage());
        }
    }
    ...
    public void test13_ObtenerTipoCambioSoportaFechaDeHoy() {
        try (Connection con = ConexionDB.obtenerConexion()) {
            ...
            LoggerUtil.info("Omitiendo verificacion de registro por fecha: " + e.getMessage());
        }
    }
    ...
    public void test14_ObtenerTipoCambioCompraVentaNoNulosEnBD() {
        try (Connection con = ConexionDB.obtenerConexion()) {
            ...
            LoggerUtil.info("Omitiendo verificacion de compra/venta no nulos: " + e.getMessage());
        }
    }
    ...
    public void test19_TipoCambioFuenteTrazabilidadNoNula() {
        try (Connection con = ConexionDB.obtenerConexion()) {
            ...
            LoggerUtil.info("Omitiendo validacion de trazabilidad de fuente: " + e.getMessage());
        }
    }
    ...
    public void test20_ObtenerTipoCambioEjecucionMultipleEsRapidaPorCache() {
        try (java.sql.Connection con = ConexionDB.obtenerConexion()) {
            ...
            LoggerUtil.info("Omitiendo validacion de cache de tipo de cambio si no hay servicio MySQL: " + e.getMessage());
        }
    }
}
