...
public class PredamValidacionServicioTest {
    ...
    public void perfumesConHs3303ExigenPermisoSectorial() throws Exception {
        ...
        PredamValidacionException ex = assertThrows(PredamValidacionException.class, () -> PredamValidacionServicio.validate(con, imp));
