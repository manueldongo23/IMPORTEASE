...
public class PanelServicioTest {
    ...
    public void sanitizeColumnPermiteSoloColumnasWhitelisted() {
        ...
        String result = PanelServicio.sanitizeColumn("valor_fob", whitelist);
    ...
    public void sanitizeColumnBloqueaPayloadNoPermitido() {
        ...
        String result = PanelServicio.sanitizeColumn("valor_fob) FROM importaciones; DROP TABLE usuarios; --", whitelist);
        assertNull(result);
    }
}
